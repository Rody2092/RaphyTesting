...
exports.run = async (client, message, args) => {
  ...
  let embed = new Discord.MessageEmbed()
    .setColor('BLUE')
    .setAuthor(`${message.author.username} está pisando em você ${user.username}`, avatar)
    .setImage(rand)
    .setFooter('Clique em 🔁 para retribuir')

  let embed2 = new Discord.MessageEmbed()
    .setColor('BLUE')
    .setAuthor(`${user.username} devolveu as pisadas ${message.author.username} `, avatar1)
    .setImage(rand1)
